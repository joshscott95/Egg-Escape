window.addEventListener('load', function(){
    ...
    class Player {
        ...
        update(){
            ...
            else if (this.collisionX > this.game.width - this.collisionRadius) this.collisionX 
    ...
    class Larva {
        ...
        update(){
            ...
            if (this.collisionY < this.game.topMargin){
                ...
                for (let i = 0; i < 3; i++) {
                    this.game.particles.push(new FireFly(this.game, this.collisionX, this.collisionY,
                    'yellow'));
                }
            }
            ...
            this.game.enemies.forEach(enemy =>{
                if (this.game.checkCollision(this, enemy)[0] && !this.game.gameOver){
                    ...
                    for (let i = 0; i < 10; i++) {
                        this.game.particles.push(new Spark(this.game, this.collisionX, this.collisionY,
                        'blue'));
                    }
                }
            });
    ...
    class Game {
        ...
        render(context, deltaTime){
            ...
            if (this.debug) context.fillText('Press "D" to turn off/on debug mode', 25, 150);
            ...
            if (this.score >= this.winningScore){
                ...
                if (this.lostHatchlings <= 5){
                    message1 = 'Bullseye!!!'
                    message2 = 'You saved the eggy boys'
                } else {
                    message1 = 'Pathetic!'
                    message2 = 'Were you even trying? ' + this.lostHatchlings + ' lost hatchlings is pretty sad'
                }
